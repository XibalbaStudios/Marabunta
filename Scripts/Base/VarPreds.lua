...
-- @return If true, variable is a negative number.
-- @see IsNegative
function IsNegative_Number (var)
...
-- @see IsInteger
function IsNegativeInteger (var)
...
function IsNegativeInteger_Number (var)
...
-- @return If true, variable is 0 or a positive number.
-- @see IsNonNegative
function IsNonNegative_Number (var)
	return _IsNumber_(var) and var >= 0
end
...
-- @see IsInteger
function IsNonNegativeInteger (var)
	return ToInteger(var) >= 0
end
...
function IsNonNegativeInteger_Number (var)
	return _IsNumber_(var) and var >= 0 and IsIntegral(var)
end
...
-- @return If true, variable is 0 or a negative number.
-- @see IsNonPositive
function IsNonPositive_Number (var)
	return _IsNumber_(var) and var <= 0
end
...
-- @see IsInteger
function IsNonPositiveInteger (var)
	return ToInteger(var) <= 0
end
...
function IsNonPositiveInteger_Number (var)
	return _IsNumber_(var) and var <= 0 and IsIntegral(var)
end
...
-- @return If true, variable is a positive number.
-- @see IsPositive
function IsPositive_Number (var)
	return _IsNumber_(var) and var > 0
end
...
function IsPositiveInteger_Number (var)
	return _IsNumber_(var) and var > 0 and IsIntegral(var)
end
...
-- Cache some routines.
_HasMeta_ = HasMeta
_IsCallable_ = IsCallable
_IsCountable_ = IsCountable
_IsIndexableR_ = IsIndexableR
_IsInteger_ = IsInteger
_IsNonNegativeInteger_ = IsNonNegativeInteger
_IsNumber_ = IsNumber
...
-- @param arg Argument.
-- @return Call results.
function CallMethod (owner, name, arg)
...
-- @return Call results.
-- @see CallMethod
function CallMethod_Multi (owner, name, ...)
...
-- @return Call results or value.
-- @see CallOrGet
function CallOrGet_Multi (value, ...)
	if IsCallable(value) then
		return value(...)
	end
...
function FuncAppender (key, message, allow_nil)
...
function FuncSetter (key, message, allow_nil)
	local pred = allow_nil and IsCallableOrNil or IsCallable
...
function Identity_AllButFirst (_, ...)
	return ...
end
...
do
	...
	function Try (func, finally, resource, arg1, arg2)
	...
	-- @see Try
	function Try_Multi (func, finally, resource, ...)
...
do
	...
	function SetTimeLapseFunc (name, func, deduct)
...
do
	...
	function GetLastTraceback (clear)
	...
	function SetTracebackFunc (func)
...
-- Cache some routines.
_NoOp_ = NoOp
_StoreTraceback_ = StoreTraceback
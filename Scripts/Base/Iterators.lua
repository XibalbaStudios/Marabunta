...
function InstancedAutocacher (builder)
...
Args = InstancedAutocacher(function()
	local args, count
...
-- @see Args
-- @see InstancedAutocacher
ArgsByN = InstancedAutocacher(function()
	local args, count
...
-- @see InstancedAutocacher
IpairsThenItem = InstancedAutocacher(function()
...
-- @see InstancedAutocacher
ItemThenIpairs = InstancedAutocacher(function()
